...
def generate_main_cpp(directory, top_model_name, simulation_time):
    '''
    ...
    Args:
        directory (str):        The output directory to place the main.hpp file.
    ...
    output_filepath = directory + "main.cpp"
